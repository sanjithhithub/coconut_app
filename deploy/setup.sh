...
# Install required packages without version locks
echo "Installing necessary packages..."
apt-get install -y python3 python3-dev python3-venv sqlite3 libsqlite3-dev python3-pip supervisor nginx git locales
